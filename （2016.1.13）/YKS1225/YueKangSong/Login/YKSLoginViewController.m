...
@interface YKSLoginViewController ()<UIAlertViewDelegate,UITextFieldDelegate>
...
- (void)senderShow:(NSTimer *)timer {
    ...
    [_codeButton setTitle:[NSString stringWithFormat:@"%zd 秒后重发", _time]
